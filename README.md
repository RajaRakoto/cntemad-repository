...
|:-----------------|:--------------------|:----------------------------------------------------------|
| **Sourcetree**   | Windows             |[[download ⬇](https://www.sourcetreeapp.com/)]             |
| **Gitbash**      | Windows - GNU/Linux |[[download ⬇](https://git-scm.com/downloads)]              |
| **Gitkraken**    | Windows - GNU/Linux |[[download ⬇](https://www.gitkraken.com/download)]         |
| **UNGIT**        | GNU/Linux           |[[download ⬇](https://github.com/FredrikNoren/ungit)]      |
| **gitvers-tool** | GNU/Linux           |[[download ⬇](https://github.com/RajaRakoto/gitvers-tool)] |
